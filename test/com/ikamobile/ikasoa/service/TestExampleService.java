...
import com.ikamobile.ikasoa.ImplClsCon;
import com.ikamobile.ikasoa.NettyIkasoaFactory;
...
public class TestExampleService extends TestCase {
	...
	public void testDefaultKryoService() {
		invoke(new DefaultIkasoaFactory(ProtocolType.KRYO), 9996);
	}

	@Test
	public void testNettyKryoService() {
		invoke(new NettyIkasoaFactory(ProtocolType.KRYO), 9997);
	}

	@Test
	public void testDefaultXmlService() {
		invoke(new DefaultIkasoaFactory(ProtocolType.XML), 9994);
	}

	@Test
	public void testNettyXmlService() {
		invoke(new NettyIkasoaFactory(ProtocolType.XML), 9995);
	}
